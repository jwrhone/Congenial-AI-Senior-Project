...
class NewBestMatchAdapter(LogicAdapter):
    """
    ...
    def process(self, input_statement, additional_response_selection_parameters=None):
        ...
        if response_list:
            ...
            phrases = ["Sorry, I don't quite understand", "I don't understand what you mean",
            "Sorry, I don't have a response for that", "How can I help you?", "That remark was too complicated for me",
            "Why, specifically?", "How can I help you?", "May I help you?", "I've lost my train of thought.",
            "My brain does not have a response for that", "What you said was too complicated for me",
            "That is a very original thought", "What were we talking about again?",
            "Not many people express themselves that way", "I enjoy speaking with you",
            "Help me understand that further", "Are you well?", "What do you want to ask ?"]
            response = Statement(text=random.choice(phrases))
